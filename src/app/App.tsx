...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col max-w-md mx-auto border-x border-slate-100">
      
      {/* HEADER: Simples, Branco, Profissional */}
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-slate-100 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <h1 className="text-xl font-bold text-slate-900 tracking-tight">Beenit</h1>
          </div>
      ...
      <main className="flex-1 overflow-y-auto pb-20 bg-slate-50/50">
        {activeTab === "feed" && <Feed />}
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-100 max-w-md mx-auto z-50">
